...
const userName = ["admin", "asad", "ali", "tariq", "raja"];
...
//assigment no 31
let noUser = ['admin', 'haya', 'hira', 'hina'];
if (noUser.length === 0) {
...
let current_users = ['faRah', 'JhOn', 'RaJa', 'Ali', 'sara'];
//• Make another list of five usernames called new_users.
let new_users = ['Issa', 'Moosa', 'Ali', 'faRah', 'mirha'];
...
let myPizza = ["vegi pizza", "cheeze pizza", "pepperoni pizza"];
